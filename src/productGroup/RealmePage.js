...
import RealmeList from './RealmeList';
import RealmeItem from './RealmeItem';
import { actGetProductRequest } from './../actions/index';

class RealmePage extends Component {
    constructor(props){
        super(props);
        this.state = {
            realme : "realme"
            ...
            <section>
                <div className="product-page-main-super container-fuild">
                    <div className="product-page-main container-fuild">
                        ...
                        <RealmeList>
                            {this.showRealme(products, this.state.realme)}
                        </RealmeList>
                    </div>
                </div>
            </section>
...
export default connect(mapStateToProps, mapDispatchToProps)(RealmePage);